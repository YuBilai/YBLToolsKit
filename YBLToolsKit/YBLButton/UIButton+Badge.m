...
//  CashierPlus
//
//  Created by HuangMeiling on 17/2/8.
//  Copyright © 2017年 ShengZhengPuTaoJingFu. All rights reserved.
//
...
{
    // 初始化，设定默认值
//    self.badgeBGColor   = COLOR_TITLE;
//    self.badgeTextColor = ORANGEColor;
...
- (void)updateBadgeFrame
{
    ...
    //固定圆
    self.badge.frame = CGRectMake(self.badgeOriginX, self.badgeOriginY,16,16);
...
-(void) setBadgeValue:(NSString *)badgeValue
{
    ...
    if (!badgeValue || [badgeValue isEqualToString:@""] || ([badgeValue isEqualToString:@"0"] && self.shouldHideBadgeAtZero)) {
        ...
        //当又有值时，重新设置角标
        self.badge                      = [[UILabel alloc] initWithFrame:CGRectMake(self.badgeOriginX, self.badgeOriginY, 16, 16)];
        self.badge.textColor            = self.badgeTextColor;
        self.badge.backgroundColor      = self.badgeBGColor;
        self.badge.font                 = self.badgeFont;
